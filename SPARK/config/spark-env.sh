...
export SPARK_HOME=/share/hadoop_custom/spark-2.0.2
export DEFAULT_HADOOP_HOME=/opt/cloudera/parcels/CDH-5.8.2-1.cdh5.8.2.p0.3/lib/hadoop
...
SPARK_EXTRA_LIB_PATH="/opt/cloudera/parcels/GPLEXTRAS-5.8.2-1.cdh5.8.2.p0.2/lib/hadoop/lib/native"
